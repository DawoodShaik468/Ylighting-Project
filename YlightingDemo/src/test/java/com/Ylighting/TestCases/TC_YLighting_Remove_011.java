...
******************************************************/
public class TC_YLighting_Remove_011 extends BaseClass {
	@Test
	public void Login() throws Exception {
		...
		LoginTest.Remove();
		logger.info("user is able to Remove product in the cart");
		...
		FileUtils.copyFile(Screenshot,
				new File("C:\\Users\\dawoo\\eclipse-workspace\\YlightingDemo\\Screenshots\\T011.png"));
