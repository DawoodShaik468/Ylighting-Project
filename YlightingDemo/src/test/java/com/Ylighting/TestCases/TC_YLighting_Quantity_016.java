...
******************************************************/
public class TC_YLighting_Quantity_016 extends BaseClass {
	@Test
	public void Login() throws Exception {
		...
		LoginTest.Quantity();
		logger.info("Quantity is Applied");
		...
		FileUtils.copyFile(Screenshot,
				new File("C:\\Users\\dawoo\\eclipse-workspace\\YlightingDemo\\Screenshots\\T016.png"));
