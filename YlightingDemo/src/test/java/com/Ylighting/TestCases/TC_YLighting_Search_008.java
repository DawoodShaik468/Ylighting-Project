...
******************************************************/
public class TC_YLighting_Search_008 extends BaseClass {
	@Test
	public void Login() throws Exception {
		...
		LoginTest.Search();
		LoginTest.Searchbtn();
		logger.info("Searched the product successfully");
		
		File Screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(Screenshot,
				new File("C:\\Users\\dawoo\\eclipse-workspace\\YlightingDemo\\Screenshots\\T008.png"));
