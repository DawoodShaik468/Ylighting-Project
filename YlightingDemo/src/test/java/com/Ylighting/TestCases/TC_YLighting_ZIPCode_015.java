...
******************************************************/
public class TC_YLighting_ZIPCode_015 extends BaseClass {
	@Test
	public void Login() throws Exception {
		...
		LoginTest.ZIPCode();
		logger.info("user is able to enter ZIP code");
		LoginTest.Go();
		logger.info("ZIPCode is Applied");
		...
		FileUtils.copyFile(Screenshot,
				new File("C:\\Users\\dawoo\\eclipse-workspace\\YlightingDemo\\Screenshots\\T015.png"));
